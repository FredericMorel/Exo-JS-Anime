...
const students = [
    { name: "Matis", firstName: "Paul", classe: "TS3", professor: "xavier", average: 15 },
    { name: "Ferer", firstName: "Pierre", classe: "TS1", professor: "dupignon", average: 19 },
    { name: "Degas", firstName: "Jerome", classe: "TS2", professor: "gravel", average: 13 }, { name: "nonin", firstName: "Etienne", classe: "TS4", professor: "algras", average: 18 }, { name: "maxwell", firstName: "Erwan", classe: "TS1", professor: "Charles", average: 14 },]
...
nameSearch.addEventListener('keyup', (event => {
    ...
    const resultName = students.filter(student => {if (student.name == inputName){
